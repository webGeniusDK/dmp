...
?>
<div id="<?php echo esc_attr( $listing_css_id ); ?>" class="listing-item" data-breakpoints='{"medium": [560,780], "large": [780,999999]}' data-breakpoints-class-prefix="wpbdp-listing-excerpt">
	<?php
	echo $blocks['before'];
