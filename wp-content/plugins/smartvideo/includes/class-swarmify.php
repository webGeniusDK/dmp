...
class Swarmify {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Swarmify_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Swarmify_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_dependencies() {
		...
		$this->loader = new Swarmify_Loader();
	 ...
	 *
	 * Uses the Swarmify_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action('wp_head',$plugin_public,'swarmify_script');
		$this->loader->add_action('admin_head',$plugin_public,'swarmify_script');
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Swarmify_Loader    Orchestrates the hooks of the plugin.
	 */
