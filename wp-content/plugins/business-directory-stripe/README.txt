=== Business Directory Plugin - Stripe Gateway ===
...
The module works with Business Directory Plugin only (https://businessdirectoryplugin.com).
...
If you have any problems installing the plugin, please [contact us](https://businessdirectoryplugin.com/contact/)
...
== Changelog ==
Version 3.6
- Allow use of a custom Stripe form instead of the Stripe button.
